...
SECRET_KEY = 'j4pq58x!gc$5r(s5kuno4-mz0ge-+n)xdw6$fc=8xyqg5jstf&'
...
INSTALLED_BACKENDS = {
    "message_tester": {
        "ENGINE": "rapidsms.backends.database.outgoing.DatabaseBackend",
    },
}
RAPIDSMS_TABS = [
  ("sendsms", "Sendsms"),
]
RAPIDSMS_ROUTER = "rapidsms.router.blocking.router.BlockingRouter"
