# Django settings for amasms project.

import os

# The top directory for this project. Contains requirements/, manage.py,
# and README.rst, a amasms directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'amasms')

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
     ('Stockman', 'kuristocky@hotmail.com'),
)
...
TINYMCE_JS_URL = os.path.join(MEDIA_ROOT, 'js/jscripts/tiny_mce/tiny_mce.js')
...
SECRET_KEY = '85y@ucz2xian222hv)!_)z2+5kl8(zz+%&wq2=)d$_t8!r81e@'
...
ROOT_URLCONF = 'amasms.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'amasms.wsgi.application'
...
SOUTH_MIGRATION_MODULES = {
	'rapidsms': 'testextension_main.migrations',
}
...
DEFAULT_RESPONSE = "Sorry, your message is not relevant"
